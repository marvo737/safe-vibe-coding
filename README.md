...
Claude Code のプラグインマーケットプレイス経由でインストールできます。

```
# このリポジトリをマーケットプレイスとして登録
/plugin marketplace add marvo737/safe-vibe-coding

# プラグインをインストール
/plugin install safe-vibe-coding@safe-vibe-coding
```

インストール後、Claude Code を再起動すると7つのスキル(`vibe-coding-overview` + 6領域)が利用可能になります。

### アップデート

```
/plugin marketplace update safe-vibe-coding
```

### アンインストール

```
/plugin uninstall safe-vibe-coding@safe-vibe-coding
/plugin marketplace remove safe-vibe-coding
```
